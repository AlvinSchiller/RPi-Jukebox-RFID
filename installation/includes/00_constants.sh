...
SHARED_FOLDERNAME="shared"
SHARED_PATH="${INSTALLATION_PATH}/${SHARED_FOLDERNAME}"
...
INSTALL_CONFIG_FILENAME="Install.conf"
INSTALL_CONFIG_CURRENT="${INSTALLATION_PATH}/${INSTALL_CONFIG_FILENAME}"
